{
  ...
  "panels": [
    ...
    },
    {
      ...
      "thresholds": "1,5",
      "title": "Audit Device Fail (request)",
      "type": "singlestat",
      "valueFontSize": "80%",
      "valueMaps": [
        {
    ...
    },
    {
      ...
      "thresholds": "1,5",
      "title": "Audit Device Fail (response)",
      "type": "singlestat",
      "valueFontSize": "80%",
      "valueMaps": [
        {
    ...
    },
    {
      ...
      "targets": [
        {
          "refId": "A",
          "target": "stats.timers.vault.rollback.attempt.vaultron-kv-.median"
        }
      ],
      "thresholds": "100,5000",
      "title": "Rollback KV",
    ...
    },
    {
      ...
      "targets": [
        {
          "refId": "A",
          "target": "stats.timers.vault.route.create.vaultron-kv-.median"
        }
      ],
      "thresholds": [],
      "timeFrom": null,
      "timeShift": null,
      "title": "KV Secret Create",
      "tooltip": {
        "shared": true,
        "sort": 0,
        "value_type": "individual"
